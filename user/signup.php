...
{		
	...
	var conditionsecond=/^\d{10}$/;
	if(!contactno.value.match(conditionsecond))
	{
	alert('Please use a 10 digit mobile no.')
	return false;
	}

	else if(!password.value.match(condition)) 
	{  
	//alert(contactno.value);
